xCard.cardEvaluator.registerCard("Dead At The Mist", function(action) {
...
xCard.cardEvaluator.registerCard("Belonging To Myself", function(action) {
...
xCard.cardEvaluator.registerCard("Assassins Of History", function(action) {
...
xCard.cardEvaluator.registerCard("Death At The Void", function(action) {
